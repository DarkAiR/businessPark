...
<body>
Откройте файл <b>.htaccess</b>, лежащий в корне вашего сайта и вставьте туда этот блок:
</br>
<pre>
...
Удобно скопировать этот блок можно отсюда:
<button class='select'>Выделить</button>
</br>
