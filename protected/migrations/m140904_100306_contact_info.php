...
class m140904_100306_contact_info extends CDbMigration
{
    public function safeUp()
    {
        $this->execute('
            ...
            VALUES
                ...
                ("salePhones", "[\"+7 (343) 344-99-99\"]", "contact-info", "Телефоны отдела продаж", "[\"+7 (343) 344-99-99\"]", "dynamicarray"),
    ...
    {
        $this->execute("
            DELETE FROM localconfig WHERE id IN ('mainPhones', 'salePhones', 'email', 'city', 'address', 'office')
        ");
    }
}
